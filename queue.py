...
class Queue(object):
    ...
    def enqueue(self, item):
        ...
        # Wasn't sure if we should be using the built-in Python list functionality
        self = self._list.append(item)
        return self

        # Here is my method of enqueing without using the .append()
        self = self._list + [item]
        return self
